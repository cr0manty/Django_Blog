...
urlpatterns = [
    ...
    path('post/<str:slug>/edit_comment/<int:id>', EditComment.as_view(), name='comment_edit_url'),
    path('post/<str:slug>/delete_comment/<int:id>', DeleteComment.as_view(), name='comment_delete_url'),
